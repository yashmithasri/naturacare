...
howto= """My chatbot analyzes input symptoms and predicts potential diseases based on them, providing users with likely disease names as output
<br><br>
...
with gr.Blocks(css = """#col_container { margin-left: auto; margin-right: auto;} #chatbot {height: 520px; overflow: auto;}""") as demo:
  gr.HTML('<h1 align="center">KAYL Chatbot: Your Virtual Health Guide 👨🏻‍⚕️🤖</h1>')
  
  with gr.Accordion("Welcome to your friendly neighbourhood medical advisor", open=True):
      gr.HTML(howto)
  chatbot = gr.Chatbot()
  msg = gr.Textbox()
